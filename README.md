...
- **作品管理**:论文 / 评论 / 草稿 / 其他成果的增删改查,按类型 / 状态 / 标签筛选 + **全文搜索(标题/摘要/作者/备注)+ 发表日期区间** + 分页;**粘贴 DOI 一键从 Crossref 导入元数据**(标题/作者/期刊/日期,离线可手填)。
...
- **导出与备份**:成果清单(按年 / 类型 × Markdown / 纯文本,可复制)、**引用格式 APA / GB-T 7714 / BibTeX**、项目结题成果清单、**整库 JSON 备份导出与一键恢复**(带结构 / 引用完整性校验 + 二次确认)。
